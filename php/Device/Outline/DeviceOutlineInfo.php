 ...
 *设备下线信息
 *
 * Generated from protobuf message <code>device.outline.DeviceOutlineInfo</code>
 */
class DeviceOutlineInfo extends \Google\Protobuf\Internal\Message
{
    /**
     *手机号码-选填
     *
     ...
     *下线时间 - 必填
     *
     * Generated from protobuf field <code>int64 outlineTime = 8;</code>
     */
     ...
     * @return int|string
     */
    public function getOutlineTime()
    {
     ...
     * @return $this
     */
    public function setOutlineTime($var)
    {
        GPBUtil::checkInt64($var);
        $this->outlineTime = $var;
