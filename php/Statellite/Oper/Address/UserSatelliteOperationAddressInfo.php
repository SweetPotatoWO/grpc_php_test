 ...
 *用户操控微信地址信息
 *
 * Generated from protobuf message <code>statellite.oper.address.UserSatelliteOperationAddressInfo</code>
 */
class UserSatelliteOperationAddressInfo extends \Google\Protobuf\Internal\Message
{
    /**
     *手机号码-必填
     *
     ...
     *操作类型 - 必填
     *
     * Generated from protobuf field <code>.statellite.oper.address.UserSatelliteOperationAddressInfo.OperationType operationType = 4;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Statellite\Oper\Address\UserSatelliteOperationAddressInfo_OperationType::class);
